...
/**
 * @method CorsicanAdvisor|null find($id, $lockMode = null, $lockVersion = null)
 * @method CorsicanAdvisor|null findOneBy(array $criteria, array $orderBy = null)
 * @method CorsicanAdvisor[]    findAll()
 * @method CorsicanAdvisor[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class CorsicanAdvisorRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, CorsicanAdvisor::class);
    }
    ...
    public function getNotNoted(int $limit) {
        $qb = $this->_em->createQueryBuilder();
        $query = $qb->select('ca.id, ca.firstName, ca.lastName, ca.departmentLabel')
            ->from($this->_entityName, 'ca')
            ->setMaxResults($limit)
            ->getQuery();
    ...
    public function getByCriteria(string $criteria) {
        ...
        $query = $qb->select('ca.id, ca.firstName, ca.lastName, ca.departmentLabel')
            ...
            ->orWhere('ca.departmentLabel LIKE :criteria')
